            ...
            <div style={{ textAlign: 'left' }}>
                ...
                <div style={{ textAlign: 'left' }}>
                    ...
                    <a target={'_blank'} ><img src={require('../../assets/MosaicIcon.png')} style={{ objectFit: 'contain', width: '7vw' }}>
                        ...
                        <a target={'_blank'} style={{ paddingLeft: 20 }} href={'https://play.google.com/store/apps/details?id=com.mirch'}><img style={{ height: 40, width: 132 }} src={require('../../assets/google-play-badge.png')}></img></a>
