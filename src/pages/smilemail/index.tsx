            ...
            <div style={{ textAlign: 'left' }}>
                <div style={{ textAlign: 'left' }}>
                    ...
                    <a target={'_blank'} href={'https://smilemail.com'}><img src={require('../../assets/logoIconSmile.png')} style={{ objectFit: 'contain', width: '7vw' }}>
                        ...
                        <a target={'_blank'} style={{ paddingLeft: 20 }} href={'https://play.google.com/store/apps/details?id=com.smilemail'}><img style={{ height: 40, width: 132 }} src={require('../../assets/google-play-badge.png')}></img></a>
                ...
                <div>
                    ...
                    <p>
                        The project was an innovative experience for Jason. He enjoyed applying his previous native IOS and android
                        development experience into a React native application. He was not in charge of the back-end of this project.
                        Through collaboration Jason and the team released a working ecommerce application.<br />
