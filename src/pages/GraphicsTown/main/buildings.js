...
export class HouseDesign3 extends GrObject {
  constructor () {
    ...
    mesh2.translateY(1);
    const mesh3 = new T.Mesh(roof, new T.MeshStandardMaterial({ map: t3, roughness: 0.75 }));
    const mesh4 = new T.Mesh(door, new T.MeshStandardMaterial({ map: t4, roughness: 0.75 }));
    const window1Mesh = new T.Mesh(window1, new T.MeshStandardMaterial({ map: t5, roughness: 0.75 }));
    const window2Mesh = new T.Mesh(window2, new T.MeshStandardMaterial({ map: t5, roughness: 0.75 }));
